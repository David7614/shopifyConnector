...
actionsall() {
	/usr/bin/php /home/yii/sambaprod.m2itsolutions.pl/yii xml-generator/generate-products | tee -a /home/yii/sambaprod.m2itsolutions.pl/logs/integration-log.txt
}
